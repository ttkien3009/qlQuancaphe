...
<body>
	<div class="Main">
		...
		<div class="Content">
			...
			<table id="Table">
				<tr>
					<th colspan='17' align='center' height=60px><b><h1>LỊCH HỌC SINH VIÊN</h1></b></th>
				</tr>
				<tr>
					<th>STT</th>
					<th>Mã Sinh Viên</th>
				...
				<%
					...
					String  masv1 = null, masv2 = null, masv3 = null;
					...
					PreparedStatement ps = con.prepareStatement(
							"select * from Mon where MaLop like ? OR MaLop like ? OR MaLop like ? OR MaMon like ? OR MaMon like ? OR MaMon like ? OR MaSV like ? OR MaSV like ? OR MaSV like ? OR SoTinChi like ? OR SoTinChi like ? OR SoTinChi like ? OR Ca like ? OR Ca like ? OR Ca like ? OR Thu like ? OR Thu like ? OR Thu like ? OR Phong like ? OR Phong like ? OR Phong like ? OR ThoiGianBatDau like ? OR ThoiGianBatDau like ? OR ThoiGianBatDau like ? OR ThoiGianKetThuc like ? OR ThoiGianKetThuc like ? OR ThoiGianKetThuc like ? ");
					...
					ps.setString(7, masv1);
					ps.setString(8, masv2);
					ps.setString(9, masv3);
					...
					while (rs.next()) {
						...
						out.println("<td><a href='UpdateShedule.jsp?MaSV=" + rs.getString("MaSV")
								+ "'><img src='Image/Admin/repair.png' width='30px' height='30px'></a></td>");
						out.println("<td><a href='DeleteShedule.jsp?MaSV=" + rs.getString("MaSV")
