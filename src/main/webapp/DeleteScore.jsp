...
<body>
	<div class="login-box">
		<h1>XÓA ĐIỂM</h1>
		<form name="form" method="post" action="DeleteScoreServlet">
			<p>Nhập mã sinh viên cần xóa điểm:</p>
			<div class="textbox">
				<input type="text" name="MaSV" value="<%=tmp%>">
			</div>
			<p>Xác nhận xóa điểm của sinh viên này?</p>
		...
		&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
		&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;
		&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="Admin.jsp?tmp=ListScore"><button
